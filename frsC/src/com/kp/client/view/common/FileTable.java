...
public class FileTable extends Table {
	...
	private static String[] attrName = {"名称","上传者","修改日期","类型","大小"};
	private static int[] attrLength = {300, 200, 150, 130, 130};
