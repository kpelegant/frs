...
public class AESUtil {
	...
	public static long addLength = 131072;//128kb  源数据长度64M减去此长度加密后为64M
	...
	/**AES加密
	 * @throws IOException */
	public static byte[] encrypt(byte[] content, String password) throws IOException{
		try {
	...
	/**AES解密
	 * @throws IOException */
	public static byte[] decrypt(byte[] content, String password) throws IOException {  
        try {  
        	SecretKeySpec key = initKey(password);  
